...
def get_student_by_github(github):
    ...
    row = db_cursor.fetchone()  # returns tuple-like object
...
def add_project(title, description, max_grade):
    ...
    QUERY = """
        INSERT INTO projects (title, description, max_grade)
            VALUES(:title, :descr, :max_gr)
            """

    db_cursor = db.session.execute(QUERY, {'title': title, "descr": description, "max_gr": max_grade})
...
def handle_input():
    ...
    while command != "quit":
        ...
        if command == "student":
            ...
            title, *description, max_gr = args
            add_project(title, ' '.join(description), max_gr)
